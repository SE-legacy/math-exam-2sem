...
#definition()[
  ...
  $I_2 in RR$ называют криволинейным интегралом второго рода от функции $P$ по кривой $L$ (в направлении от $A$ до $B$) и обозначают, как
...
#theorem(name: "Теорема (условия существования криволинейных интегралов )")[
  Если $L = L_overline(gamma)$ --- гладкая кривая, функции $f$, $P$, $Q$ непрерывны вдоль этой кривой, то все три криволинейных интеграла существуют, и
  ...
  Определенные интегралы, стоящие в правых частях формул существуют, т.к. их подынтегральные функции непрерывны на отрезке $[a,b]$.
