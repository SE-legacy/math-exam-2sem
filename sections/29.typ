...
#theorem(name: [Теорема (неравенство Коши--Буняковского--Шварца)])[
  ...
  Если $B = 0$, то $y_i = 0, #h(6pt) i = 1, dots, m$ и неравенство принимает вид $0 <= 0$.
...
#definition()[
  Отображение множества $NN$ во множество $RR^m$ называется последовательностью и обозначается $(overline(x)_n)$ или $(overline(x)_n)_(n=1)^(infinity)$, где
