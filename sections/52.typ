...
3) $forall$ кусочного глад. контура $L$, в обл. $D$, верно рав.:$limits(integral.cont)_L P(x,y) d x + Q(x,y) d y = 0 $;
...
2) $=>$ 3): Пусть $L$ - произвол. кусочно глад. контур в $D$. По формуле Грина: $limits(integral.cont)_L P d x + Q d y = integral.double_D ((diff Q) / (diff x) - (diff P) / (diff y)) d x d y = 0 $, так как подынтег. ф. тожд. равна нулю. \
3) $<=>$ 4): Следует из Т., которая говорит, что чтобы криволин. интег. в обл. $D$ не зависел от пути интег. необ. и дост. чтобы $forall$ кусоч. конт. $L$ в $D$ вып.: $limits(integral.cont)_L P(x,y) d x + Q(x,y) d y = 0 $ \
