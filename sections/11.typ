...
#theorem(name: "Теорема (признак Дирихле)")[
  Пусть функции $f$, $g$, $g'$ непрерывны на $[a, omega)$, функция $F(b) = limits(integral)_a^b f(x) d x$ ограничена на $[a, omega)$, $g(x) -> 0$, монотонно убывая, при $x -> omega$. Тогда несобственный интеграл $limits(integral)_a^omega f(x)g(x) d x$ сходится.
][
...
#theorem(name: "Теорема (признак Абеля)")[
  ...
  #text(tracking: 3pt)[ДОКАЗАТЬ САМОСТОЯТЕЛЬНО #emoji.skull.]
]
