...
$f$ определена и ограничена на $[a,b], #h(4pt) M_k = limits(sup)_(x in Delta_k_n)f(x) , #h(4pt) m_k = limits(inf)_(x in Delta_k_n)f(x), k = overline(1\, n)$. 
...
$forall P_1 #h(4pt) forall epsilon > 0 #h(4pt) exists xi_P quad 0<=S(P)-sigma(P,xi_P) < epsilon quad (0<=sigma(P,xi_P)-s(P)<epsilon)$.
][
