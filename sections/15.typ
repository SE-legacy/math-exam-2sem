...
#theorem(name: "Теорема (признак мажорации)")[
  $forall n in NN #h(6pt) a_n >= 0, #h(6pt) b_n >=0, #h(6pt) a_n = O(b_n), #h(6pt) limits(sum)^infinity_(n=1) b_n < + infinity.$ Тогда $sum a_n < + infinity$.
][
...
#consequence(name: "Следствие 1")[
  $forall n in NN #h(6pt) a_n >= 0, #h(6pt) b_n >= 0$, последовательность $(a_n/b_n)$ сходится, #h(6pt) $limits(sum)^infinity_(n=1) b_n < + infinity$. Тогда $limits(sum)^infinity_(n=1) a_n < + infinity$.
][]

#consequence(name: "Следствие 2")[
  $forall n in NN #h(6pt) a_n > 0, #h(6pt) b_n > 0, #h(6pt) a_(n+1)/a_n <= b_(n+1)/b_n$, #h(6pt) $limits(sum)^infinity_(n=1) b_n < + infinity ==> limits(sum)^infinity_(n=1) a_n < + infinity$.
][]
