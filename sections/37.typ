...
#theorem(name: "Теорема (о дифференцируемости сложной функции)")[
  ...
  $
    (partial (f compose overline(g)))/(partial t_j) (overline(t)_0) = (partial f)/(partial x_1) (overline(x)_0) (partial g_1)/(partial t_j) (overline(t)_0) +
    (partial f)/(partial x_2) (overline(x)_0) (partial g_2)/(partial t_j) (overline(t)_0) + dots + (partial f)/(partial x_m) (overline(x)_0) (partial g_m)/(partial t_j) (overline(t)_0).
  $
][
  ...
  где функции $phi_i$ $(i = 1, dots, m)$ непрерывны в точке $overline(x)_0$ и $phi_i (overline(x)_0) = (partial f)/(partial x_i) (overline(x)_0)$.
  ...
  и $psi_(i j)(overline(t)_0) = (partial g_i)/(partial t_j) (overline(t)_0)$. Тогда
  ...
  $
    (partial (f compose overline(g)))/(partial t_j) (overline(t)_0) = limits(sum)_(i=1)^m phi_i (overline(g) (overline(t)_0)) psi_(i j) (overline(t)_0) = limits(sum)_(i=1)^m phi_i (overline(x)_0) psi_(i j) (overline(t)_0) = limits(sum)_(i=1)^m (partial f)/(partial x_i) (overline(x)_0) (partial g_i)/(partial t_j) (overline(t)_0).
  $
]
