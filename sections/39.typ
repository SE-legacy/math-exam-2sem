...
#definition()[
  Пусть частная производная $(partial f )/(partial x_i)$ существует в некоторой окрестности точки $overline(x)_0$ и функция $(partial f )/(partial x_i)$ имеет в точке $overline(x)_0$ частную производную по переменной $x_j$. Частная производная второго порядка определяется равенством
...
#theorem(name: "Теорема (о равенстве смешанных производных)")[
  ...
  и, переходя к пределу при $h -> 0$, в силу непрерывности обеих частных производных в $(x_0, y_0)$, получаем
