...
#theorem(name: "Теорема (о непрерывности дифференцируемой функции)")[
  Функция $overline(f)$ дифференцируема в точке $t_0$ $==>$ функция $overline(f)$ непрерывна в точке $t_0$.
][]

#theorem()[
  Функция $overline(f) = (f_1, dots, f_k)$ дифференцируема в точке $t_0$ $<==>$ все её координатные функции $f_1, dots, f_k$ дифференцируемы в точке $t_0$, причём $overline(f)' (t_0) = (f'_1 (t_0), dots, f'_k (t_0))$.
][]
