...
#theorem(
  ...
  Пусть $f$ непрерывна на $[a, b]$, то по теореме Кантора $f$ равномерно непрерывна на $[a, b]$.
...
#theorem(
  ...
  Функция $f$ монотонна на $[a, b] ==> f$ интегрируема на $[a, b]$.
][
  Если $f = c = "const"$, то $f$ интегрируема и $limits(integral)_a^b f(x) d x = c(b - a)$.

  Пусть $f != "const"$ и $f arrow.t, #h(6pt) P = P_([a,b]) = {x_k}_(k = 0)^n, #h(6pt) Delta_k = [x_(k - 1), x_k]$, тогда
