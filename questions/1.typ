...
#def $[a,b] subset RR; #h(4pt) P = P_([a,b]) = {x_k}^n_(k=0)$ наз. разбиением отрезка $[a,b]$. \
...
#def Пусть $f$ опр. на $[a,b], #h(4pt) sigma(P) = sigma(f, P, xi_p) = limits(sum)^n_(k=1)f(xi_k)Delta x_k$ наз. интегральной сумма Римана.\
#def $I in RR, I = limits(lim)_(d(P) -> 0)sigma(P)$ наз. пределом инт. сумм Римана $<==>$\
