...
Пусть $epsilon > 0 quad f$ непр. в т. $x_(0) ==> exists delta > 0$ такое, что $forall t in [a, b]: abs(t - x_(0)) < delta$ выполнается условие $abs(f(t) - f(x_(0))) < epsilon$. Тогда, если $abs(h) < delta$, то 
