...
#def Пусть функ. $f$ дифф в т. $overline(x)_0$. Градиентом функ. $f$ в т. $overline(x)_0$ наз. век. \
$g r a d f(overline(x)_0) = ((diff f) / (diff x_1)(overline(x)_0), (diff f) / (diff x_2)(overline(x)_0),..., (diff f) / (diff x_m)(overline(x)_0))$

#properties
+ Век. градиент указывает направление, по которому функ. имеет макс. произ. в т. $overline(x)_0$;
+ Знач. произ. функ. по направлению, опр. градиентом этой функ. в т. $overline(x)_0$, равно длине век. град. 