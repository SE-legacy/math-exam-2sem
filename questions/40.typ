...
#def Пусть $f$ n-дифф. в т. $overline(x)_0$. Ее n-дифф. в этой точке наз. функ. $d^n f(overline(x)_0): RR^m -> RR$, что $forall overline(h) in RR^m$: $d^n f(overline(x)_0)(overline(h)) = d(d^(n-1)_overline(h) f)(overline(x)_0)(overline(h))$
