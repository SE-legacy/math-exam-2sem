...
+ знакоопределена, то в т. $overline(x)_0$ функ. имеет лок. экс., который является строгим лок. мин., если квадр. форма положит. опр., и строгим лок. макс, если она отриц. опр;
+ неопределена, то в т. $overline(x)_0$ функ. экс. не имеет.
#proof поберегите мозг. не надо 
