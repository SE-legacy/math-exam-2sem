...
*Т. (Достат. усл. лок. экс.)* Пусть $f$ опр. в нек. окр. $O(overline(x)_0), f in C^((2)) (O(overline(x)_0))$ и т. $overline(x)_0$ является стационар. т. этой функ. Если квадратичная форма $d^2 f(overline(x)_0)(overline(h)) = sum_(i,j=1)^m (diff^2 f)/(diff x_j diff x_i) (overline(x)_0)h_i h_j$ \
1) знакоопределена, то в т. $overline(x)_0$ функ. имеет лок. экс., который является строгим лок. мин., если квадр. форма положит. опр., и строким лок. макс, если она отриц. опр\
