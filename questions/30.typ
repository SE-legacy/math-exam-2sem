...
*Опр.* Функ. $f$ наз. инт. (по Риману) на мн. $D$ если $exists I = limits(lim)_(d(T)->0) sigma(T)$, где $T$ - разбиение квадрируемого замкн. мн., $d(T)$ - диаметр разбиения $T$, a $sigma(T)$ - интеграл. сумма. Число $I$ наз. двойным интег. от функ. $f(x,y)$ по мн. D и обознач. $I = limits(integral.double)_D f(x,y) d x d y $.\
