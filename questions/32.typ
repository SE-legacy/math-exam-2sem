...
#def Пусть функ. $overline(f) : RR -> RR^k quad k > 1$, и т. $t_0$ --- внутр. точка обл. опред. функ. $overline(f)$
...
#theorem() Функ. $overline(f) = (f_1, dots, f_k)$ дифф. в т. $overline(t)_0$ $<=>$ все её коорд. функ. $f_1, dots, f_k$ дифф. в т. $t_0$, причём
$overline(f)^(prime) (t_0) = (f_1^(prime) (t_0), dots, f_k^(prime) (t_0))$ \ 
#conseq(number: 1) Если функ. $overline(f)$ и $overline(g)$ дифф. в т. $overline(x)_0$, то их сумма, разность, произв. на число и скал. произв. дифф. в т. $overline(x)_0$, причём:
$(overline(f) plus.minus overline(g))^(prime) (x_0) = (overline(f)^(prime) (x_0) plus.minus overline(g)^(prime) (x_0))$;
$(overline(lambda f)^(prime)) (x_0) = lambda overline(f)^prime (x_0) quad lambda in RR$;
$(overline(f) dot overline(g))^(prime) (x_0) = overline(f)^(prime) (x_0) dot overline(g) (x_0) + overline(f) (x_0) dot overline(g)^(prime) (x_0)$ \ 
#conseq(number: 2) Если функ. $overline(f)$ дифф. в $t_0$, а скалярная функ. $g$ дифф. в т. $u_0$ и $g(u_0) = t_0$, то $overline(f) compose g$ дифф.
в т. $u_0$ и $(overline(f) compose g)^(prime) (u_0) = overline(f)^(prime) (t_0) dot g^(prime) (u_0)$

#theorem(name: "лок. формула Тейлора") Пусть функ. $overline(f)$ $n$-дифф. в т. $overline(t)_0$, тогда
...
$g(b) - g(a) = g^prime (xi)(b-a) = (overline(f)^prime (xi), overline(e))(b-a) <= abs(overline(f)^prime (xi))(b-a)$. #qed
