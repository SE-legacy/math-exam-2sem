...
+ $omega in RR, f in Re [a, omega] ==>$ знач–я $limits(integral)_(a)^(omega) f(x) d x$ в несобств. и собств. смысле равны.

+ $forall lambda a_(1), lambda a_(2) in RR$ ф–ция $lambda a_(1) f + lambda a_(2) g$ инт. в несобств. смысле и $limits(integral)_(a)^(omega) (lambda a_(1) f(x) + lambda a_(2) g(x)) d x = lambda a_(1) limits(integral)_(a)^(omega) f(x) d x + lambda a_(2) limits(integral)_(a)^(omega) g(x) d x$.
