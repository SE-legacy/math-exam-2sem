// Частные производные функции многих переменных. Дифференцируемость в точке функции многих переменных. Теорема о непрерывности дифференцируемой функции

#heading(level: 1)[35]

Пусть функ. $f : X -> RR$, опр. на множ. $X subset RR^m$, и т. $overline(x_0)$ --- внутр. т. обл. опр. функ. $f$. 

Частной производной функ. $f$ по первой переменной в т. $overline(x_0) = (x_1^0, dots, x_m^0)$ называют предел 
...
Пусть т. $overline(x)_0$ --- внутр. т. обл. опр. функ. $overline(f)$. 
